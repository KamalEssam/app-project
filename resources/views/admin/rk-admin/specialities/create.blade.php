...
@section('title', trans('lang.create_speciality'))
            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-primary">
                    <div class="panel-body">
                        <h1 class="font-18 loon">{{trans('lang.create_speciality')}}</h1>
                        <hr>
                        {!! Form::open(['route' => 'specialities.store', 'files' => true]) !!}
                        @include('admin.rk-admin.specialities.form', ['btn' => 'Add', 'classes' => 'btn-xs pull-right'])
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
