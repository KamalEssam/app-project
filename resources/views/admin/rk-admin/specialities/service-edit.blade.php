            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-primary">
                    <div class="panel-body">
                        <h1 class="font-18 loon">{{trans('lang.edit_service')}}
                            : {{ $service->{ app()->getLocale() . '_name' } }} </h1>
                        <hr>
                        {!! Form::model($service, ['route' => ['services.edit', $service->id], 'method' => 'PATCH']) !!}
                        <div class="row">
                        ...
                        {{ Form::hidden('speciality_id',$service->speciality_id) }}
