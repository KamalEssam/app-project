            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-primary">
                    <div class="panel-body">
                        <h1 class="font-18 loon">{{trans('lang.add_sub_speciality')}}
                            ...
                            @endif</h1>
                        <hr>
                        {!! Form::open(['route' => 'specialities.sub-store']) !!}

                        {{ Form::hidden('speciality_id',Request::segment(2)) }}
                        <div class="fields" id="other">
                            <div class="add-new-sub_speciality">
...
@section('scripts')
    <script>
        $('.add-other').click(function () {
            var oth = $('.add-new-sub_speciality').html();
